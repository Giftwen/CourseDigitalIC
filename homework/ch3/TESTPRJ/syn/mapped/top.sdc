...
# Created by write_sdc on Tue Oct  4 12:04:08 2022
...
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[7]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[7]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[6]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[6]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[5]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[5]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[4]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[4]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[3]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[3]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[2]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[2]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[1]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[1]}]
set_input_delay -clock clk  -max 3.8  [get_ports {bin_in[0]}]
set_input_delay -clock clk  -min 0  [get_ports {bin_in[0]}]
set_input_delay -clock clk  -max 3.8  [get_ports sampling]
set_input_delay -clock clk  -min 0  [get_ports sampling]
set_output_delay -clock clk  -max 3.8  [get_ports flag]
set_output_delay -clock clk  -min 0  [get_ports flag]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[9]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[9]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[8]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[8]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[7]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[7]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[6]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[6]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[5]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[5]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[4]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[4]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[3]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[3]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[2]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[2]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[1]}]
set_output_delay -clock clk  -min 0  [get_ports {bcd_out[1]}]
set_output_delay -clock clk  -max 3.8  [get_ports {bcd_out[0]}]
